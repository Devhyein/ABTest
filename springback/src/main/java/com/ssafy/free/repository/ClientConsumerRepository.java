...
public interface ClientConsumerRepository
        extends JpaRepository<ClientConsumer, Integer>, JpaSpecificationExecutor<ClientConsumer> {
    ...
    ClientConsumer findBySessionIdAndTestNo(String session_id, int test_no);
}
