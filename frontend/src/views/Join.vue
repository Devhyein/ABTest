    ...
    <b-container fluid class="container">
        <b-card bg-variant="light" @submit.stop.prevent="join">
            ...
            <b-row class="my-2">
                ...
                <b-col sm="9">
                <b-form-input id="input-pw" v-model="form.pw" placeholder="Enter Password" type="password"></b-form-input>
                </b-col>
            </b-row>
            <b-row class="my-3">
                <b-col sm="2">
                ...
                <b-col sm="9">
                <b-form-input id="input-chpw" :state="checkPw" v-model="chpw" placeholder="Enter Password" type="password"></b-form-input>
                </b-col>
            </b-row>
            <b-row class="my-4">
                <b-col sm="2">
